(function() {
	var h = {},
		mt = {},
		c = {
			id: "2cf72659cbc23a8782393071312e40c9",
			dm: ["qichemen.com"],
				...
				_trackRTEvent: function(a) {
					...
					if(d.d(a, "Object")) {
						...
						if(900 >= m) g.call(this, a);
							...
							for(var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.Q).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++) l.push(v), l.push(a.substring(900 * v, 900 * v + 900)), g.call(this, s + l.join("|")), l = []
					}
				},
